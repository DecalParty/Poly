exports.id=558,exports.ids=[558],exports.modules={21150:()=>{},38054:(e,t,a)=>{"use strict";a.d(t,{db:()=>w,jO:()=>b,Bw:()=>O,fK:()=>n});var n={};a.r(n),a.d(n,{dailyStats:()=>N,marketPerformance:()=>p,settings:()=>T,trades:()=>u});var s=a(58757),i=a(92048),l=a(55315),o=a(87106),r=a(5795),L=a(53586),E=a(54341),d=a(20449);let u=(0,o.Px)("trades",{id:(0,r._L)("id").primaryKey({autoIncrement:!0}),timestamp:(0,L.fL)("timestamp").notNull(),conditionId:(0,L.fL)("condition_id").notNull(),slug:(0,L.fL)("slug").notNull(),side:(0,L.fL)("side",{enum:["yes","no"]}).notNull(),action:(0,L.fL)("action",{enum:["buy","sell","resolution"]}).notNull(),price:(0,E.kw)("price").notNull(),amount:(0,E.kw)("amount").notNull(),shares:(0,E.kw)("shares").notNull(),pnl:(0,E.kw)("pnl"),paper:(0,r._L)("paper",{mode:"boolean"}).notNull().default(!0),orderId:(0,L.fL)("order_id"),asset:(0,L.fL)("asset"),subStrategy:(0,L.fL)("sub_strategy"),binancePriceAtEntry:(0,E.kw)("binance_price_at_entry"),slippage:(0,E.kw)("slippage"),takerFee:(0,E.kw)("taker_fee")}),T=(0,o.Px)("settings",{id:(0,r._L)("id").primaryKey().default(1),buyAmount:(0,E.kw)("buy_amount").notNull().default(.1),buyIntervalSeconds:(0,r._L)("buy_interval_seconds").notNull().default(5),entryPriceMin:(0,E.kw)("entry_price_min").notNull().default(.9),entryPriceMax:(0,E.kw)("entry_price_max").notNull().default(.95),stopLossThreshold:(0,E.kw)("stop_loss_threshold").notNull().default(.5),maxMinutesRemaining:(0,r._L)("max_minutes_remaining").notNull().default(8),maxPositionSize:(0,E.kw)("max_position_size").notNull().default(5),paperTrading:(0,r._L)("paper_trading",{mode:"boolean"}).notNull().default(!0),totalBankroll:(0,E.kw)("total_bankroll").notNull().default(50),maxTotalExposure:(0,E.kw)("max_total_exposure").notNull().default(30),reserveAmount:(0,E.kw)("reserve_amount").notNull().default(20),perWindowMax:(0,E.kw)("per_window_max").notNull().default(8),maxSimultaneousPositions:(0,r._L)("max_simultaneous_positions").notNull().default(3),dailyLossLimit:(0,E.kw)("daily_loss_limit").notNull().default(10),consecutiveLossLimit:(0,r._L)("consecutive_loss_limit").notNull().default(5),enabledAssets:(0,L.fL)("enabled_assets").notNull().default('["BTC"]'),momentumMinPriceChange:(0,E.kw)("momentum_min_price_change").notNull().default(.001),momentumEntryMin:(0,E.kw)("momentum_entry_min").notNull().default(.6),momentumEntryMax:(0,E.kw)("momentum_entry_max").notNull().default(.93),momentumTimeMin:(0,r._L)("momentum_time_min").notNull().default(120),momentumTimeMax:(0,r._L)("momentum_time_max").notNull().default(480),momentumEnabled:(0,r._L)("momentum_enabled",{mode:"boolean"}).notNull().default(!0),highConfEntryMin:(0,E.kw)("high_conf_entry_min").notNull().default(.88),highConfEntryMax:(0,E.kw)("high_conf_entry_max").notNull().default(.96),highConfTimeMin:(0,r._L)("high_conf_time_min").notNull().default(60),highConfTimeMax:(0,r._L)("high_conf_time_max").notNull().default(480),highConfEnabled:(0,r._L)("high_conf_enabled",{mode:"boolean"}).notNull().default(!0),highConfBuyAmount:(0,E.kw)("high_conf_buy_amount").notNull().default(.1),highConfBuyInterval:(0,r._L)("high_conf_buy_interval").notNull().default(5),highConfStopLoss:(0,E.kw)("high_conf_stop_loss").notNull().default(.79),arbitrageEnabled:(0,r._L)("arbitrage_enabled",{mode:"boolean"}).notNull().default(!0),arbMaxPerWindow:(0,E.kw)("arb_max_per_window").notNull().default(10),arbBudgetUp:(0,E.kw)("arb_budget_up"),arbBudgetDown:(0,E.kw)("arb_budget_down"),arbLadderLevels:(0,L.fL)("arb_ladder_levels").notNull().default('[{"price":0.48,"allocation":0.40},{"price":0.46,"allocation":0.35},{"price":0.44,"allocation":0.25}]'),maxCombinedCost:(0,E.kw)("max_combined_cost").notNull().default(.97),arbCancelBeforeEnd:(0,r._L)("arb_cancel_before_end").notNull().default(120),arbMarket:(0,L.fL)("arb_market").notNull().default("BTC"),scalpEnabled:(0,r._L)("scalp_enabled",{mode:"boolean"}).notNull().default(!0),scalpTradeSize:(0,E.kw)("scalp_trade_size").notNull().default(12),scalpMaxPositions:(0,r._L)("scalp_max_positions").notNull().default(2),scalpMinGap:(0,E.kw)("scalp_min_gap").notNull().default(.03),scalpProfitTarget:(0,E.kw)("scalp_profit_target").notNull().default(.03),scalpEntryMin:(0,E.kw)("scalp_entry_min").notNull().default(.15),scalpEntryMax:(0,E.kw)("scalp_entry_max").notNull().default(.85),scalpCooldownWindows:(0,r._L)("scalp_cooldown_windows").notNull().default(1),scalpExitWindow:(0,r._L)("scalp_exit_window").notNull().default(120),betAmount:(0,E.kw)("bet_amount").notNull().default(2)}),N=(0,o.Px)("daily_stats",{date:(0,L.fL)("date").primaryKey(),totalTrades:(0,r._L)("total_trades").notNull().default(0),wins:(0,r._L)("wins").notNull().default(0),losses:(0,r._L)("losses").notNull().default(0),pnl:(0,E.kw)("pnl").notNull().default(0),feesSpent:(0,E.kw)("fees_spent").notNull().default(0),arbitrageTrades:(0,r._L)("arbitrage_trades").notNull().default(0),momentumTrades:(0,r._L)("momentum_trades").notNull().default(0),highConfTrades:(0,r._L)("high_conf_trades").notNull().default(0),circuitBreakerTriggered:(0,r._L)("circuit_breaker_triggered").notNull().default(0)}),p=(0,o.Px)("market_performance",{asset:(0,L.fL)("asset").notNull(),date:(0,L.fL)("date").notNull(),trades:(0,r._L)("trades").notNull().default(0),wins:(0,r._L)("wins").notNull().default(0),losses:(0,r._L)("losses").notNull().default(0),pnl:(0,E.kw)("pnl").notNull().default(0)},e=>({pk:(0,d.CK)({columns:[e.asset,e.date]})})),_=(0,l.join)(process.cwd(),"data"),m=(0,l.join)(_,"trades.db");(0,i.existsSync)(_)||(0,i.mkdirSync)(_,{recursive:!0});let c=null;function g(){if(c)return c;throw Error("Database not initialized - call ensureDb() first")}function f(){let e=g().export();(0,i.writeFileSync)(m,Buffer.from(e))}class U{constructor(e){this.isRaw=!1,this.sql=e}raw(e=!0){return this.isRaw=e,this}bind(){return this}run(...e){let t=g(),a=1===e.length&&Array.isArray(e[0])?e[0]:e;return t.run(this.sql,a),f(),{changes:t.getRowsModified(),lastInsertRowid:0}}get(...e){let t=g(),a=1===e.length&&Array.isArray(e[0])?e[0]:e,n=t.prepare(this.sql);if(a.length>0&&n.bind(a),n.step()){if(this.isRaw){let e=n.get();return n.free(),e}let e=n.getColumnNames(),t=n.get(),a={};return e.forEach((e,n)=>a[e]=t[n]),n.free(),a}n.free()}all(...e){let t=g(),a=1===e.length&&Array.isArray(e[0])?e[0]:e,n=[],s=t.prepare(this.sql);for(a.length>0&&s.bind(a);s.step();)if(this.isRaw)n.push(s.get());else{let e=s.getColumnNames(),t=s.get(),a={};e.forEach((e,n)=>a[e]=t[n]),n.push(a)}return s.free(),n}}let A={prepare:e=>new U(e),exec(e){g().run(e),f()},pragma(e){},transaction:e=>()=>{g().run("BEGIN");try{let t=e();return g().run("COMMIT"),f(),t}catch(e){throw g().run("ROLLBACK"),e}}},h=null;function b(){return c?Promise.resolve():h||(h=(async()=>{let e=a(80470),t=await e();if((0,i.existsSync)(m)){let e=(0,i.readFileSync)(m);c=new t.Database(e)}else c=new t.Database;c.run(`
