exports.id=558,exports.ids=[558],exports.modules={21150:()=>{},38054:(e,t,n)=>{"use strict";n.d(t,{db:()=>O,jO:()=>b,Bw:()=>R,fK:()=>a});var a={};n.r(a),n.d(a,{dailyStats:()=>N,marketPerformance:()=>m,settings:()=>T,trades:()=>d});var i=n(58757),s=n(92048),r=n(55315),o=n(87106),l=n(5795),L=n(53586),E=n(54341),u=n(20449);let d=(0,o.Px)("trades",{id:(0,l._L)("id").primaryKey({autoIncrement:!0}),timestamp:(0,L.fL)("timestamp").notNull(),conditionId:(0,L.fL)("condition_id").notNull(),slug:(0,L.fL)("slug").notNull(),side:(0,L.fL)("side",{enum:["yes","no"]}).notNull(),action:(0,L.fL)("action",{enum:["buy","sell","resolution"]}).notNull(),price:(0,E.kw)("price").notNull(),amount:(0,E.kw)("amount").notNull(),shares:(0,E.kw)("shares").notNull(),pnl:(0,E.kw)("pnl"),paper:(0,l._L)("paper",{mode:"boolean"}).notNull().default(!0),orderId:(0,L.fL)("order_id"),asset:(0,L.fL)("asset"),subStrategy:(0,L.fL)("sub_strategy"),binancePriceAtEntry:(0,E.kw)("binance_price_at_entry"),slippage:(0,E.kw)("slippage"),takerFee:(0,E.kw)("taker_fee")}),T=(0,o.Px)("settings",{id:(0,l._L)("id").primaryKey().default(1),buyAmount:(0,E.kw)("buy_amount").notNull().default(.1),buyIntervalSeconds:(0,l._L)("buy_interval_seconds").notNull().default(5),entryPriceMin:(0,E.kw)("entry_price_min").notNull().default(.9),entryPriceMax:(0,E.kw)("entry_price_max").notNull().default(.95),stopLossThreshold:(0,E.kw)("stop_loss_threshold").notNull().default(.5),maxMinutesRemaining:(0,l._L)("max_minutes_remaining").notNull().default(8),maxPositionSize:(0,E.kw)("max_position_size").notNull().default(5),paperTrading:(0,l._L)("paper_trading",{mode:"boolean"}).notNull().default(!0),totalBankroll:(0,E.kw)("total_bankroll").notNull().default(50),maxTotalExposure:(0,E.kw)("max_total_exposure").notNull().default(30),reserveAmount:(0,E.kw)("reserve_amount").notNull().default(20),perWindowMax:(0,E.kw)("per_window_max").notNull().default(8),maxSimultaneousPositions:(0,l._L)("max_simultaneous_positions").notNull().default(3),dailyLossLimit:(0,E.kw)("daily_loss_limit").notNull().default(10),consecutiveLossLimit:(0,l._L)("consecutive_loss_limit").notNull().default(5),enabledAssets:(0,L.fL)("enabled_assets").notNull().default('["BTC"]'),momentumMinPriceChange:(0,E.kw)("momentum_min_price_change").notNull().default(.001),momentumEntryMin:(0,E.kw)("momentum_entry_min").notNull().default(.6),momentumEntryMax:(0,E.kw)("momentum_entry_max").notNull().default(.93),momentumTimeMin:(0,l._L)("momentum_time_min").notNull().default(120),momentumTimeMax:(0,l._L)("momentum_time_max").notNull().default(480),momentumEnabled:(0,l._L)("momentum_enabled",{mode:"boolean"}).notNull().default(!0),highConfEntryMin:(0,E.kw)("high_conf_entry_min").notNull().default(.88),highConfEntryMax:(0,E.kw)("high_conf_entry_max").notNull().default(.96),highConfTimeMin:(0,l._L)("high_conf_time_min").notNull().default(60),highConfTimeMax:(0,l._L)("high_conf_time_max").notNull().default(480),highConfEnabled:(0,l._L)("high_conf_enabled",{mode:"boolean"}).notNull().default(!0),highConfBuyAmount:(0,E.kw)("high_conf_buy_amount").notNull().default(.1),highConfBuyInterval:(0,l._L)("high_conf_buy_interval").notNull().default(5),highConfStopLoss:(0,E.kw)("high_conf_stop_loss").notNull().default(.79),arbitrageEnabled:(0,l._L)("arbitrage_enabled",{mode:"boolean"}).notNull().default(!0),arbMaxPerWindow:(0,E.kw)("arb_max_per_window").notNull().default(10),arbBudgetUp:(0,E.kw)("arb_budget_up"),arbBudgetDown:(0,E.kw)("arb_budget_down"),arbLadderLevels:(0,L.fL)("arb_ladder_levels").notNull().default('[{"price":0.48,"allocation":0.40},{"price":0.46,"allocation":0.35},{"price":0.44,"allocation":0.25}]'),maxCombinedCost:(0,E.kw)("max_combined_cost").notNull().default(.97),arbCancelBeforeEnd:(0,l._L)("arb_cancel_before_end").notNull().default(120),arbMarket:(0,L.fL)("arb_market").notNull().default("BTC"),betAmount:(0,E.kw)("bet_amount").notNull().default(2)}),N=(0,o.Px)("daily_stats",{date:(0,L.fL)("date").primaryKey(),totalTrades:(0,l._L)("total_trades").notNull().default(0),wins:(0,l._L)("wins").notNull().default(0),losses:(0,l._L)("losses").notNull().default(0),pnl:(0,E.kw)("pnl").notNull().default(0),feesSpent:(0,E.kw)("fees_spent").notNull().default(0),arbitrageTrades:(0,l._L)("arbitrage_trades").notNull().default(0),momentumTrades:(0,l._L)("momentum_trades").notNull().default(0),highConfTrades:(0,l._L)("high_conf_trades").notNull().default(0),circuitBreakerTriggered:(0,l._L)("circuit_breaker_triggered").notNull().default(0)}),m=(0,o.Px)("market_performance",{asset:(0,L.fL)("asset").notNull(),date:(0,L.fL)("date").notNull(),trades:(0,l._L)("trades").notNull().default(0),wins:(0,l._L)("wins").notNull().default(0),losses:(0,l._L)("losses").notNull().default(0),pnl:(0,E.kw)("pnl").notNull().default(0)},e=>({pk:(0,u.CK)({columns:[e.asset,e.date]})})),_=(0,r.join)(process.cwd(),"data"),p=(0,r.join)(_,"trades.db");(0,s.existsSync)(_)||(0,s.mkdirSync)(_,{recursive:!0});let g=null;function c(){if(g)return g;throw Error("Database not initialized - call ensureDb() first")}function f(){let e=c().export();(0,s.writeFileSync)(p,Buffer.from(e))}class h{constructor(e){this.isRaw=!1,this.sql=e}raw(e=!0){return this.isRaw=e,this}bind(){return this}run(...e){let t=c(),n=1===e.length&&Array.isArray(e[0])?e[0]:e;return t.run(this.sql,n),f(),{changes:t.getRowsModified(),lastInsertRowid:0}}get(...e){let t=c(),n=1===e.length&&Array.isArray(e[0])?e[0]:e,a=t.prepare(this.sql);if(n.length>0&&a.bind(n),a.step()){if(this.isRaw){let e=a.get();return a.free(),e}let e=a.getColumnNames(),t=a.get(),n={};return e.forEach((e,a)=>n[e]=t[a]),a.free(),n}a.free()}all(...e){let t=c(),n=1===e.length&&Array.isArray(e[0])?e[0]:e,a=[],i=t.prepare(this.sql);for(n.length>0&&i.bind(n);i.step();)if(this.isRaw)a.push(i.get());else{let e=i.getColumnNames(),t=i.get(),n={};e.forEach((e,a)=>n[e]=t[a]),a.push(n)}return i.free(),a}}let U={prepare:e=>new h(e),exec(e){c().run(e),f()},pragma(e){},transaction:e=>()=>{c().run("BEGIN");try{let t=e();return c().run("COMMIT"),f(),t}catch(e){throw c().run("ROLLBACK"),e}}},A=null;function b(){return g?Promise.resolve():A||(A=(async()=>{let e=n(80470),t=await e();if((0,s.existsSync)(p)){let e=(0,s.readFileSync)(p);g=new t.Database(e)}else g=new t.Database;g.run(`
  ...
  `).all().map(e=>({strategy:e.sub_strategy,trades:e.trades,wins:e.wins,losses:e.losses,winRate:e.trades>0?e.wins/e.trades:0,pnl:e.pnl,avgPnl:e.avg_pnl}))}function g(e=30){let t=new Date(Date.now()-864e5*e).toISOString().slice(0,10);return r.Bw.prepare(`
    ...
    ORDER BY date
  `).all(t).map(e=>({date:e.date,pnl:e.pnl,trades:e.trades,wins:e.wins,losses:e.losses}))}function c(){return r.Bw.prepare(`
