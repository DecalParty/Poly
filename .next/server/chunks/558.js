exports.id=558,exports.ids=[558],exports.modules={21150:()=>{},38054:(e,t,a)=>{"use strict";a.d(t,{db:()=>O,jO:()=>b,Bw:()=>y,fK:()=>n});var n={};a.r(n),a.d(n,{dailyStats:()=>N,marketPerformance:()=>_,settings:()=>T,trades:()=>d});var i=a(58757),l=a(92048),s=a(55315),r=a(87106),o=a(5795),L=a(53586),E=a(54341),u=a(20449);let d=(0,r.Px)("trades",{id:(0,o._L)("id").primaryKey({autoIncrement:!0}),timestamp:(0,L.fL)("timestamp").notNull(),conditionId:(0,L.fL)("condition_id").notNull(),slug:(0,L.fL)("slug").notNull(),side:(0,L.fL)("side",{enum:["yes","no"]}).notNull(),action:(0,L.fL)("action",{enum:["buy","sell","resolution"]}).notNull(),price:(0,E.kw)("price").notNull(),amount:(0,E.kw)("amount").notNull(),shares:(0,E.kw)("shares").notNull(),pnl:(0,E.kw)("pnl"),paper:(0,o._L)("paper",{mode:"boolean"}).notNull().default(!0),orderId:(0,L.fL)("order_id"),asset:(0,L.fL)("asset"),subStrategy:(0,L.fL)("sub_strategy"),binancePriceAtEntry:(0,E.kw)("binance_price_at_entry"),slippage:(0,E.kw)("slippage"),takerFee:(0,E.kw)("taker_fee")}),T=(0,r.Px)("settings",{id:(0,o._L)("id").primaryKey().default(1),buyAmount:(0,E.kw)("buy_amount").notNull().default(.1),buyIntervalSeconds:(0,o._L)("buy_interval_seconds").notNull().default(5),entryPriceMin:(0,E.kw)("entry_price_min").notNull().default(.9),entryPriceMax:(0,E.kw)("entry_price_max").notNull().default(.95),stopLossThreshold:(0,E.kw)("stop_loss_threshold").notNull().default(.5),maxMinutesRemaining:(0,o._L)("max_minutes_remaining").notNull().default(8),maxPositionSize:(0,E.kw)("max_position_size").notNull().default(5),paperTrading:(0,o._L)("paper_trading",{mode:"boolean"}).notNull().default(!0),totalBankroll:(0,E.kw)("total_bankroll").notNull().default(50),maxTotalExposure:(0,E.kw)("max_total_exposure").notNull().default(30),reserveAmount:(0,E.kw)("reserve_amount").notNull().default(20),perWindowMax:(0,E.kw)("per_window_max").notNull().default(8),maxSimultaneousPositions:(0,o._L)("max_simultaneous_positions").notNull().default(3),dailyLossLimit:(0,E.kw)("daily_loss_limit").notNull().default(10),consecutiveLossLimit:(0,o._L)("consecutive_loss_limit").notNull().default(5),enabledAssets:(0,L.fL)("enabled_assets").notNull().default('["BTC"]'),momentumMinPriceChange:(0,E.kw)("momentum_min_price_change").notNull().default(.001),momentumEntryMin:(0,E.kw)("momentum_entry_min").notNull().default(.6),momentumEntryMax:(0,E.kw)("momentum_entry_max").notNull().default(.93),momentumTimeMin:(0,o._L)("momentum_time_min").notNull().default(120),momentumTimeMax:(0,o._L)("momentum_time_max").notNull().default(480),momentumEnabled:(0,o._L)("momentum_enabled",{mode:"boolean"}).notNull().default(!0),highConfEntryMin:(0,E.kw)("high_conf_entry_min").notNull().default(.88),highConfEntryMax:(0,E.kw)("high_conf_entry_max").notNull().default(.96),highConfTimeMin:(0,o._L)("high_conf_time_min").notNull().default(60),highConfTimeMax:(0,o._L)("high_conf_time_max").notNull().default(480),highConfEnabled:(0,o._L)("high_conf_enabled",{mode:"boolean"}).notNull().default(!0),highConfBuyAmount:(0,E.kw)("high_conf_buy_amount").notNull().default(.1),highConfBuyInterval:(0,o._L)("high_conf_buy_interval").notNull().default(5),highConfStopLoss:(0,E.kw)("high_conf_stop_loss").notNull().default(.79),arbitrageEnabled:(0,o._L)("arbitrage_enabled",{mode:"boolean"}).notNull().default(!0),arbMaxPerWindow:(0,E.kw)("arb_max_per_window").notNull().default(10),arbBudgetUp:(0,E.kw)("arb_budget_up"),arbBudgetDown:(0,E.kw)("arb_budget_down"),arbLadderLevels:(0,L.fL)("arb_ladder_levels").notNull().default('[{"price":0.48,"allocation":0.40},{"price":0.46,"allocation":0.35},{"price":0.44,"allocation":0.25}]'),maxCombinedCost:(0,E.kw)("max_combined_cost").notNull().default(.97),arbCancelBeforeEnd:(0,o._L)("arb_cancel_before_end").notNull().default(120),arbMarket:(0,L.fL)("arb_market").notNull().default("BTC"),scalpEnabled:(0,o._L)("scalp_enabled",{mode:"boolean"}).notNull().default(!0),scalpTradeSize:(0,E.kw)("scalp_trade_size").notNull().default(12),scalpMaxPositions:(0,o._L)("scalp_max_positions").notNull().default(2),scalpMinGap:(0,E.kw)("scalp_min_gap").notNull().default(.02),scalpProfitTarget:(0,E.kw)("scalp_profit_target").notNull().default(.03),scalpEntryMin:(0,E.kw)("scalp_entry_min").notNull().default(.15),scalpEntryMax:(0,E.kw)("scalp_entry_max").notNull().default(.85),scalpCooldownWindows:(0,o._L)("scalp_cooldown_windows").notNull().default(1),scalpExitWindow:(0,o._L)("scalp_exit_window").notNull().default(120),scalpHalfSizeAfter:(0,o._L)("scalp_half_size_after").notNull().default(420),valueEnabled:(0,o._L)("value_enabled",{mode:"boolean"}).notNull().default(!0),valueTradeSize:(0,E.kw)("value_trade_size").notNull().default(15),valueMaxPositions:(0,o._L)("value_max_positions").notNull().default(1),valueMinGap:(0,E.kw)("value_min_gap").notNull().default(.03),valueProfitTarget:(0,E.kw)("value_profit_target").notNull().default(.03),valueEntryMin:(0,E.kw)("value_entry_min").notNull().default(.2),valueEntryMax:(0,E.kw)("value_entry_max").notNull().default(.8),valueExitWindow:(0,o._L)("value_exit_window").notNull().default(60),valueMaxSecondsRemaining:(0,o._L)("value_max_seconds_remaining").notNull().default(480),betAmount:(0,E.kw)("bet_amount").notNull().default(2)}),N=(0,r.Px)("daily_stats",{date:(0,L.fL)("date").primaryKey(),totalTrades:(0,o._L)("total_trades").notNull().default(0),wins:(0,o._L)("wins").notNull().default(0),losses:(0,o._L)("losses").notNull().default(0),pnl:(0,E.kw)("pnl").notNull().default(0),feesSpent:(0,E.kw)("fees_spent").notNull().default(0),arbitrageTrades:(0,o._L)("arbitrage_trades").notNull().default(0),momentumTrades:(0,o._L)("momentum_trades").notNull().default(0),highConfTrades:(0,o._L)("high_conf_trades").notNull().default(0),circuitBreakerTriggered:(0,o._L)("circuit_breaker_triggered").notNull().default(0)}),_=(0,r.Px)("market_performance",{asset:(0,L.fL)("asset").notNull(),date:(0,L.fL)("date").notNull(),trades:(0,o._L)("trades").notNull().default(0),wins:(0,o._L)("wins").notNull().default(0),losses:(0,o._L)("losses").notNull().default(0),pnl:(0,E.kw)("pnl").notNull().default(0)},e=>({pk:(0,u.CK)({columns:[e.asset,e.date]})})),p=(0,s.join)(process.cwd(),"data"),m=(0,s.join)(p,"trades.db");(0,l.existsSync)(p)||(0,l.mkdirSync)(p,{recursive:!0});let c=null;function g(){if(c)return c;throw Error("Database not initialized - call ensureDb() first")}function f(){let e=g().export();(0,l.writeFileSync)(m,Buffer.from(e))}class U{constructor(e){this.isRaw=!1,this.sql=e}raw(e=!0){return this.isRaw=e,this}bind(){return this}run(...e){let t=g(),a=1===e.length&&Array.isArray(e[0])?e[0]:e;return t.run(this.sql,a),f(),{changes:t.getRowsModified(),lastInsertRowid:0}}get(...e){let t=g(),a=1===e.length&&Array.isArray(e[0])?e[0]:e,n=t.prepare(this.sql);if(a.length>0&&n.bind(a),n.step()){if(this.isRaw){let e=n.get();return n.free(),e}let e=n.getColumnNames(),t=n.get(),a={};return e.forEach((e,n)=>a[e]=t[n]),n.free(),a}n.free()}all(...e){let t=g(),a=1===e.length&&Array.isArray(e[0])?e[0]:e,n=[],i=t.prepare(this.sql);for(a.length>0&&i.bind(a);i.step();)if(this.isRaw)n.push(i.get());else{let e=i.getColumnNames(),t=i.get(),a={};e.forEach((e,n)=>a[e]=t[n]),n.push(a)}return i.free(),n}}let A={prepare:e=>new U(e),exec(e){g().run(e),f()},pragma(e){},transaction:e=>()=>{g().run("BEGIN");try{let t=e();return g().run("COMMIT"),f(),t}catch(e){throw g().run("ROLLBACK"),e}}},h=null;function b(){return c?Promise.resolve():h||(h=(async()=>{let e=a(80470),t=await e();if((0,l.existsSync)(m)){let e=(0,l.readFileSync)(m);c=new t.Database(e)}else c=new t.Database;c.run(`
    ...
    `);let n=(e,t,a)=>{try{c.run(`ALTER TABLE ${e} ADD COLUMN ${t} ${a}`)}catch{}};n("trades","asset","TEXT"),n("trades","sub_strategy","TEXT"),n("trades","binance_price_at_entry","REAL"),n("trades","slippage","REAL"),n("trades","taker_fee","REAL"),n("settings","total_bankroll","REAL NOT NULL DEFAULT 50"),n("settings","max_total_exposure","REAL NOT NULL DEFAULT 30"),n("settings","reserve_amount","REAL NOT NULL DEFAULT 20"),n("settings","per_window_max","REAL NOT NULL DEFAULT 8"),n("settings","max_simultaneous_positions","INTEGER NOT NULL DEFAULT 3"),n("settings","daily_loss_limit","REAL NOT NULL DEFAULT 10"),n("settings","consecutive_loss_limit","INTEGER NOT NULL DEFAULT 5"),n("settings","enabled_assets","TEXT NOT NULL DEFAULT '[\"BTC\"]'"),n("settings","momentum_min_price_change","REAL NOT NULL DEFAULT 0.001"),n("settings","momentum_entry_min","REAL NOT NULL DEFAULT 0.60"),n("settings","momentum_entry_max","REAL NOT NULL DEFAULT 0.93"),n("settings","momentum_time_min","INTEGER NOT NULL DEFAULT 120"),n("settings","momentum_time_max","INTEGER NOT NULL DEFAULT 480"),n("settings","momentum_enabled","INTEGER NOT NULL DEFAULT 1"),n("settings","high_conf_entry_min","REAL NOT NULL DEFAULT 0.88"),n("settings","high_conf_entry_max","REAL NOT NULL DEFAULT 0.96"),n("settings","high_conf_time_min","INTEGER NOT NULL DEFAULT 60"),n("settings","high_conf_time_max","INTEGER NOT NULL DEFAULT 300"),n("settings","high_conf_enabled","INTEGER NOT NULL DEFAULT 1"),n("settings","high_conf_buy_amount","REAL NOT NULL DEFAULT 0.10"),n("settings","high_conf_buy_interval","INTEGER NOT NULL DEFAULT 5"),n("settings","high_conf_stop_loss","REAL NOT NULL DEFAULT 0.79"),n("settings","max_combined_cost","REAL NOT NULL DEFAULT 0.97"),n("settings","arbitrage_enabled","INTEGER NOT NULL DEFAULT 1"),n("settings","bet_amount","REAL NOT NULL DEFAULT 2.00"),n("settings","arb_max_per_window","REAL NOT NULL DEFAULT 10"),n("settings","arb_ladder_levels",'TEXT NOT NULL DEFAULT \'[{"price":0.48,"allocation":0.40},{"price":0.46,"allocation":0.35},{"price":0.44,"allocation":0.25}]\''),n("settings","arb_budget_up","REAL"),n("settings","arb_budget_down","REAL"),n("settings","arb_cancel_before_end","INTEGER NOT NULL DEFAULT 120"),n("settings","arb_market","TEXT NOT NULL DEFAULT 'BTC'"),n("settings","scalp_enabled","INTEGER NOT NULL DEFAULT 1"),n("settings","scalp_trade_size","REAL NOT NULL DEFAULT 12"),n("settings","scalp_max_positions","INTEGER NOT NULL DEFAULT 2"),n("settings","scalp_min_gap","REAL NOT NULL DEFAULT 0.03"),n("settings","scalp_profit_target","REAL NOT NULL DEFAULT 0.03"),n("settings","scalp_entry_min","REAL NOT NULL DEFAULT 0.15"),n("settings","scalp_entry_max","REAL NOT NULL DEFAULT 0.85"),n("settings","scalp_cooldown_windows","INTEGER NOT NULL DEFAULT 1"),n("settings","scalp_exit_window","INTEGER NOT NULL DEFAULT 120"),n("settings","scalp_half_size_after","INTEGER NOT NULL DEFAULT 420"),n("settings","value_enabled","INTEGER NOT NULL DEFAULT 1"),n("settings","value_trade_size","REAL NOT NULL DEFAULT 15"),n("settings","value_max_positions","INTEGER NOT NULL DEFAULT 1"),n("settings","value_min_gap","REAL NOT NULL DEFAULT 0.03"),n("settings","value_profit_target","REAL NOT NULL DEFAULT 0.03"),n("settings","value_entry_min","REAL NOT NULL DEFAULT 0.20"),n("settings","value_entry_max","REAL NOT NULL DEFAULT 0.80"),n("settings","value_exit_window","INTEGER NOT NULL DEFAULT 60"),n("settings","value_max_seconds_remaining","INTEGER NOT NULL DEFAULT 480"),c.run(`UPDATE settings SET
      ...
      WHERE ROUND(scalp_min_gap, 2) NOT IN (0.01, 0.02)
         ...
         OR ROUND(scalp_entry_max, 2) != 0.85`),c.run("INSERT OR IGNORE INTO settings (id) VALUES (1)"),f()})())}let O=(0,i.t)(A,{schema:n}),y=A},3412:(e,t,a)=>{"use strict";a.d(t,{UP:()=>f,vs:()=>_,NW:()=>E,Ql:()=>c,XJ:()=>g,sS:()=>p,xc:()=>m,Jl:()=>d,JU:()=>h,lv:()=>L,Gw:()=>U,uF:()=>N,_l:()=>T,yW:()=>u,Ei:()=>o,sE:()=>b,VP:()=>A});var n=a(31626),i=a(57745),l=a(81445),s=a(38054);let r={paperTrading:!0,maxTotalExposure:30,dailyLossLimit:10,lossLimit:5,enabledAssets:["BTC"],highConfEntryMin:.9,highConfEntryMax:.95,highConfTimeMin:30,highConfTimeMax:480,highConfEnabled:!1,highConfBuyAmount:.1,highConfBuyInterval:5,arbEnabled:!1,arbMaxPerWindow:10,arbBudgetUp:null,arbBudgetDown:null,arbLadderLevels:[{price:.48,allocation:.4},{price:.46,allocation:.35},{price:.44,allocation:.25}],arbMaxCombinedCost:.97,arbCancelBeforeEnd:120,arbMarket:"BTC",scalpEnabled:!0,scalpTradeSize:12,scalpMaxPositions:2,scalpMinGap:.02,scalpProfitTarget:.02,scalpEntryMin:.15,scalpEntryMax:.85,scalpExitWindow:120,scalpHalfSizeAfter:420,valueEnabled:!0,valueTradeSize:15,valueMaxPositions:1,valueMinGap:.03,valueProfitTarget:.03,valueEntryMin:.2,valueEntryMax:.8,valueExitWindow:60,valueMaxSecondsRemaining:480};function o(e){var t;return{id:(t=s.db.insert(s.fK.trades).values({timestamp:e.timestamp,conditionId:e.conditionId,slug:e.slug,side:e.side,action:e.action,price:e.price,amount:e.amount,shares:e.shares,pnl:e.pnl,paper:e.paper,orderId:e.orderId,asset:e.asset,subStrategy:e.subStrategy,binancePriceAtEntry:e.binancePriceAtEntry,slippage:e.slippage,takerFee:e.takerFee}).returning().get()).id,timestamp:t.timestamp,conditionId:t.conditionId,slug:t.slug,side:t.side,action:t.action,price:t.price,amount:t.amount,shares:t.shares,pnl:t.pnl,paper:t.paper,orderId:t.orderId,asset:t.asset||null,subStrategy:t.subStrategy||null,binancePriceAtEntry:t.binancePriceAtEntry??null,slippage:t.slippage??null,takerFee:t.takerFee??null}}function L(e=50,t){let a="SELECT * FROM trades",n=[],i=[];return t?.asset&&(n.push("asset = ?"),i.push(t.asset)),t?.strategy&&(n.push("sub_strategy = ?"),i.push(t.strategy)),t?.from&&(n.push("timestamp >= ?"),i.push(t.from)),t?.to&&(n.push("timestamp <= ?"),i.push(t.to)),n.length>0&&(a+=" WHERE "+n.join(" AND ")),a+=" ORDER BY id DESC LIMIT ?",i.push(e),s.Bw.prepare(a).all(...i).map(e=>({id:e.id,timestamp:e.timestamp,conditionId:e.condition_id,slug:e.slug,side:e.side,action:e.action,price:e.price,amount:e.amount,shares:e.shares,pnl:e.pnl,paper:!!e.paper,orderId:e.order_id,asset:e.asset,subStrategy:e.sub_strategy,binancePriceAtEntry:e.binance_price_at_entry??null,slippage:e.slippage??null,takerFee:e.taker_fee??null}))}function E(){let e=s.db.select({total:(0,n.i6)`COALESCE(SUM(pnl), 0)`}).from(s.fK.trades).where((0,i.eq)(s.fK.trades.paper,!1)).get();return e?.total??0}function u(){let e=s.db.select({count:(0,n.i6)`COUNT(*)`}).from(s.fK.trades).where((0,i.eq)(s.fK.trades.paper,!1)).get();return e?.count??0}function d(){let e=s.db.select().from(s.fK.trades).orderBy(s.fK.trades.id).all(),t=0;return e.filter(e=>null!==e.pnl).map(e=>(t+=e.pnl??0,{timestamp:e.timestamp,pnl:e.pnl??0,cumulativePnl:t}))}function T(){let e=new Date().toISOString().slice(0,10),t=s.db.select({total:(0,n.i6)`COALESCE(SUM(pnl), 0)`}).from(s.fK.trades).where((0,n.i6)`timestamp >= ${e}`).get();return t?.total??0}function N(){let e=new Date().toISOString().slice(0,10),t=s.db.select({count:(0,n.i6)`COUNT(*)`}).from(s.fK.trades).where((0,n.i6)`pnl IS NOT NULL AND pnl < 0 AND timestamp >= ${e}`).get();return t?.count??0}function _(){let e=s.db.select({pnl:s.fK.trades.pnl}).from(s.fK.trades).where((0,n.i6)`pnl IS NOT NULL`).orderBy((0,l.C)(s.fK.trades.id)).limit(20).all(),t=0;for(let a of e)if((a.pnl??0)>0)t++;else break;return t}function p(e=30){let t=new Date(Date.now()-864e5*e).toISOString();return s.Bw.prepare(`
    SELECT asset,
           COUNT(*) as trades,
    ...
    GROUP BY asset
  `).all(t).map(e=>({asset:e.asset,trades:e.trades,wins:e.wins,losses:e.losses,winRate:e.trades>0?e.wins/e.trades:0,pnl:e.pnl}))}function m(){return s.Bw.prepare(`
    SELECT sub_strategy,
           COUNT(*) as trades,
           SUM(CASE WHEN pnl > 0 THEN 1 ELSE 0 END) as wins,
           SUM(CASE WHEN pnl < 0 THEN 1 ELSE 0 END) as losses,
  ...
  `).all().map(e=>({strategy:e.sub_strategy,trades:e.trades,wins:e.wins,losses:e.losses,winRate:e.trades>0?e.wins/e.trades:0,pnl:e.pnl,avgPnl:e.avg_pnl}))}function c(e=30){let t=new Date(Date.now()-864e5*e).toISOString().slice(0,10);return s.Bw.prepare(`
    ...
    ORDER BY date
  `).all(t).map(e=>({date:e.date,pnl:e.pnl,trades:e.trades,wins:e.wins,losses:e.losses}))}function g(){return s.Bw.prepare(`
